...
export const PUT = async (req, {params}) => {   
    ...
    await MenuItem.findByIdAndUpdate(id, { title, description, price, image }, { new: true });
...
export const POST = async (req, {params}) => {
    ...
    await ConnectMongoDB();
    const result = await MenuItem.updateOne({ _id: id }, { $set: { title, description, price, image } }); 
